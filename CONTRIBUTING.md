# Contributing to file-dropzone-element

file-dropzone-element welcomes new contributors. This document will guide you
through the process.
...
If you have questions about how to use file-dropzone-element, check our documentation on the [Wiki][wiki]. Alternatively, check [Stack Overflow][stack] to see if it has been answered there, and post your question there if not. Please tag it with Web-Component.
...
* **file-dropzone-element Version** - is it a named version or from our master branch
...
#### Fork file-dropzone-element

Fork the project [on GitHub](https://github.com/grtjn/file-dropzone-element/fork) and clone
your copy.

```sh
$ git clone git@github.com:username/file-dropzone-element.git
$ cd file-dropzone-element
$ git remote add upstream git://github.com/grtjn/file-dropzone-element.git
```
...
Go to https://github.com/username/file-dropzone-element and select your feature branch. Click
...
[wiki]: https://github.com/grtjn/file-dropzone-element/wiki
[stack]: http://stackoverflow.com/questions/tagged/web-component
[issue tracker]: https://github.com/grtjn/file-dropzone-element/issues
